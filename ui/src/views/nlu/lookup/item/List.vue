...
import { listLookupItem, disableLookupItem, removeLookupItem, batchRemoveLookupItem, resortLookupItem } from '@/api/manage'
...
export default {
  ...
  methods: {
    ...
    resort (evt) {
      ...
      resortLookupItem(src.id, target.id, this.lookupId).then(json => {
